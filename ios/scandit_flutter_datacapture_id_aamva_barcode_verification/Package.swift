...
targets.insert(
    .target(
        name: "scandit_flutter_datacapture_id_aamva_barcode_verification",
        dependencies: targetDeps,
        path: "Sources/scandit_flutter_datacapture_id_aamva_barcode_verification"
    ),
    at: 0
)
...
let package = Package(
    ...
    products: [
        .library(
            name: "scandit-flutter-datacapture-id-aamva-barcode-verification",
            targets: ["scandit_flutter_datacapture_id_aamva_barcode_verification"]
        )
    ],
